...
def clients():
    ...
    return render_template('clients.html', client=clients, search_form=search_form, search_results=search_results)
...
def edit_property(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('view_properties'))
    return render_template('edit_property.html', property=property, b64encode=b64encode)
...
def update_property(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('view_properties'))
    return render_template('update_property.html', property=property, form=form)
...
def client_properties(client_id):
    client_id_or_name = request.form['client_id']
